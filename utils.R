...
# # Filter out duplicate rows (TODO: Fix bug creating duplicates)
# mc_sections[["exac"]] = mc_sections[["exac"]][
#   !(duplicated(paste(mc_sections[["exac"]]$transcript, mc_sections[["exac"]]$section_start))),
# ]
